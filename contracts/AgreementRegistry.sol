...
/// Other modules (Funding, MilestonePayout, RefundDispute, ReputationToken)
/// inherit this contract directly.
abstract contract AgreementRegistry {
    ...
    error WrongStatus(uint256 agreementId, AgreementStatus expected, AgreementStatus actual);
    ...
    event AgreementStatusChanged(uint256 indexed agreementId, AgreementStatus oldStatus, AgreementStatus newStatus);
    ...
    modifier onlyParticipant(uint256 agreementId) {
        ...
        if (msg.sender != a.shipper && msg.sender != a.carrier) revert NotParticipant(agreementId);
        _;
    }
